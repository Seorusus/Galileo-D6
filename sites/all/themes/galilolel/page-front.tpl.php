<?php
// $Id: page-front.tpl.php,v 1.1.2.16 2010/11/16 14:39:39 himerus Exp $
?>
...
<head>
    ...
    <meta name="alexaVerifyID" content="phnGUqAk6DnbuhSjUgP8YlK2TEQ" />
...
<meta name="google-site-verification" content="Nz2lonQ9gY9a0NaWL23FbsFnrxzmxnyFjt0ZrdoK0l4" />
...
$ua=getBrowser();
$yourbrowser= $ua['name'];?>
<!-- yourbrowser  <?= $yourbrowser; ?> HTTP_USER_AGENT <?= $_SERVER['HTTP_USER_AGENT']; ?>-->
<?php
...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/he_IL/sdk.js#xfbml=1&version=v2.3&appId=318381845016934";
...
<?php if (!empty($admin)) print $admin; ?>
		...
		<div class="container">
	       ...
	       <?php echo '</div>'; } ?>
			...
			<div id="homeMainContent" >
		   		<?php echo $homeMainContent; ?>
		    </div>

		    <div class="cleared" ></div>
		    <div id="homeSmallAdd" >
		   		<?php echo $homeSmallAdd; ?>
		    </div>
		   ...
		   <div id="footerArea">  
		   		...
		   		<?php if (!empty($footer_message) && (trim($footer_message) != '')) {  
			        ...
			        //echo '<div id="bottoSupport" ><p class="rtecenter"><a href="http://auroraweb.co.il" target="_blank">פיתוח אתרים - אורורה ווב</a></p></div>';
			    }?>
	...
	<!--[if lt IE 9]>
		<script src="http://cdn4.galilole.org.il/sites/all/themes/galilolel/roundIE.js"></script>
	<![endif]--> 

<script type="text/javascript" src="http://cdn4.galilole.org.il/sites/all/themes/galilolel/jquery.marquee.js"></script>
<script type="text/javascript" src="http://cdn4.galilole.org.il/sites/all/themes/galilolel/scripts/admin.js"></script>
