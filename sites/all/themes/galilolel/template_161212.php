...
$navigate=0;
//for MSIE
if (preg_match("/msie/", $who)) $navigate=1; 
...
$css_pager_current="'pager-current'";	
$css_pager_next="'pager-next'";	
  //echo $css_pager_previous;
if ($navigate == 1){
$css_pager_previous="'pager-previousie'";	
$css_pager_current="'pager-currentie'";	
$css_pager_next="'pager-nextie'";	
}
if ($navigate == 1 ){
  $li_previous = theme('pager-previousie', (isset($tags[1]) ? $tags[1] :"<img src='/sites/all/themes/galilolel/images/next-horizontal.png' />"), $limit, $element, 1, $parameters);
  if (empty($li_previous)) {
    $li_previous = "<img src='/sites/all/themes/galilolel/images/next-horizontal.png' />";
  }
  $li_next = theme('pager-nextie', (isset($tags[3]) ? $tags[3] : "<img src='/sites/all/themes/galilolel/images/prev-horizontal.png' />"), $limit, $element, 1, $parameters);
  if (empty($li_next)) {
    $li_next = "<img src='/sites/all/themes/galilolel/images/prev-horizontal.png' />";
  }
}else{
	$li_previous = theme('pager-previous', (isset($tags[1]) ? $tags[1] :"<img src='/sites/all/themes/galilolel/images/next-horizontal.png' />"), $limit, $element, 1, $parameters);
  if (empty($li_previous)) {
    $li_previous = "<img src='/sites/all/themes/galilolel/images/next-horizontal.png' />";
  }
  $li_next = theme('pager-next', (isset($tags[3]) ? $tags[3] : "<img src='/sites/all/themes/galilolel/images/prev-horizontal.png' />"), $limit, $element, 1, $parameters);
  if (empty($li_next)) {
    $li_next = "<img src='/sites/all/themes/galilolel/images/prev-horizontal.png' />";
}
}
