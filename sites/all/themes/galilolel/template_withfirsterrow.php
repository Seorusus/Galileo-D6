...
$css_pager_next="'pager-nextie'";	
  ...
  $li_previous = theme($css_pager_previous, (isset($tags[1]) ? $tags[1] :"<img src='/sites/all/themes/galilolel/images/next-horizontal.png' />"), $limit, $element, 1, $parameters);
  if (empty($li_previous)) {
    $li_previous = "<img src='/sites/all/themes/galilolel/images/next-horizontal.png' />";
  }
  $li_next = theme($css_pager_next, (isset($tags[3]) ? $tags[3] : "<img src='/sites/all/themes/galilolel/images/prev-horizontal.png' />"), $limit, $element, 1, $parameters);
  if (empty($li_next)) {
